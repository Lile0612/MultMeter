...
void vModeBus_Query_Primary(void)
{
   ...
   memcpy((u8 *)&RtuPrimaryDataTmp[0], (u8 *)&RtuPrimaryData[0],144);
    __nop();
}
...
void vModeBus_Set_Ctrl_Parm(void)
{
    ...
    for(i = 0; i<Len; i++)
    {
        ...
        switch(rtu_RxPack.RR_DsAddr - 0x0800 + i)
        {
            case Index_8_Net:
                ParamTemp.NetMode=
			    (u8)JudgeSetNewValue(&UpDataRTU,(s32)ParamTemp.NetMode,(s32*)&RtuCTRLDataTemp[DsAddr],MIN_NetMode,MAX_NetMode);
				break;
		    case Index_8_Pt:
                ParamTemp.PTNum=
			    (u16)JudgeSetNewValue(&UpDataRTU,(s32)ParamTemp.PTNum,(s32*)&RtuCTRLDataTemp[DsAddr],MIN_PT,MAX_PT);
				break;
		    case Index_8_Ct:
                ParamTemp.CTNum=
			    (u16)JudgeSetNewValue(&UpDataRTU,(s32)ParamTemp.CTNum,(s32*)&RtuCTRLDataTemp[DsAddr],MIN_CT,MAX_CT);
				break;
		    case Index_8_Addr:
                ParamTemp.Addr485=
			    (u8)JudgeSetNewValue(&UpDataRTU,(s32)ParamTemp.Addr485,(s32*)&RtuCTRLDataTemp[DsAddr],MIN_Addr,MAX_Addr);
				break;
			case Index_8_Baud:
                ParamTemp.Baud485=
			    (u16)JudgeSetNewValue(&UpDataRTU,(s32)ParamTemp.Baud485,(s32*)&RtuCTRLDataTemp[DsAddr],MIN_Baud,MAX_Baud);
				break;
			case Index_8_Data:
                ParamTemp.DataFormat=
			    (u8)JudgeSetNewValue(&UpDataRTU,(s32)ParamTemp.DataFormat,(s32*)&RtuCTRLDataTemp[DsAddr],MIN_DataFormat,MAX_DataFormat);
				break;
			case Index_8_Cyc:
               ParamTemp.Cycle=
			    (u8)JudgeSetNewValue(&UpDataRTU,(s32)ParamTemp.Cycle,(s32*)&RtuCTRLDataTemp[DsAddr],MIN_Cycle,MAX_Cycle);
				break;
			case Index_8_Ligh:
                ParamTemp.BlackTime=
			    (u16)JudgeSetNewValue(&UpDataRTU,(s32)ParamTemp.BlackTime,(s32*)&RtuCTRLDataTemp[DsAddr],MIN_BlackTime,MAX_BlackTime);
				break;
			case Index_8_AO1_Mode:
                ParamTemp.AO1_Mode=
			    (u8)JudgeSetNewValue(&UpDataRTU,(s32)ParamTemp.AO1_Mode,(s32*)&RtuCTRLDataTemp[DsAddr],MIN_AO_Mode,MAX_AO_Mode);
				break;
			case Index_8_AO1_Item:
                ParamTemp.AO1_Item=
			    (u8)JudgeSetNewValue(&UpDataRTU,(s32)ParamTemp.AO1_Item,(s32*)&RtuCTRLDataTemp[DsAddr],MIN_AO_Item,MAX_AO_Item);
				break;
			case Index_8_AO1_Fs:
                ParamTemp.AO1_FS=
			    (u16)JudgeSetNewValue(&UpDataRTU,(s32)ParamTemp.AO1_FS,(s32*)&RtuCTRLDataTemp[DsAddr],MIN_AO_FS,MAX_AO_FS);
				break;
			case Index_8_AO1_Ds:
                ParamTemp.AO1_DS=
			    (u16)JudgeSetNewValue(&UpDataRTU,(s32)ParamTemp.AO1_DS,(s32*)&RtuCTRLDataTemp[DsAddr],MIN_AO_DS,MAX_AO_DS);
				break;
			case Index_8_AO2_Mode:
                ParamTemp.AO2_Mode=
			    (u8)JudgeSetNewValue(&UpDataRTU,(s32)ParamTemp.AO2_Mode,(s32*)&RtuCTRLDataTemp[DsAddr],MIN_AO_Mode,MAX_AO_Mode);
				break;
			case Index_8_AO2_Item:
                ParamTemp.AO2_Item=
			    (u8)JudgeSetNewValue(&UpDataRTU,(s32)ParamTemp.AO2_Item,(s32*)&RtuCTRLDataTemp[DsAddr],MIN_AO_Item,MAX_AO_Item);
				break;
			case Index_8_AO2_Fs:
                ParamTemp.AO2_FS=
			    (u16)JudgeSetNewValue(&UpDataRTU,(s32)ParamTemp.AO2_FS,(s32*)&RtuCTRLDataTemp[DsAddr],MIN_AO_FS,MAX_AO_FS);
				break;
			case Index_8_AO2_Ds:
                ParamTemp.AO2_DS=
			    (u16)JudgeSetNewValue(&UpDataRTU,(s32)ParamTemp.AO2_DS,(s32*)&RtuCTRLDataTemp[DsAddr],MIN_AO_DS,MAX_AO_DS);
				break;
			/*-------------------------------------------------------------------------------------------------------------------------------------*/
			case Index_8_DO1_Mode:
                ParamTemp.DO1_Mode=
			    (u8)JudgeSetNewValue(&UpDataRTU,(s32)ParamTemp.DO1_Mode,(s32*)&RtuCTRLDataTemp[DsAddr],MIN_DO_Mode,MAX_DO_Mode);
				break;
			case Index_8_DO1_Time:
                ParamTemp.DO1_Time=
			    (u16)JudgeSetNewValue(&UpDataRTU,(s32)ParamTemp.DO1_Time,(s32*)&RtuCTRLDataTemp[DsAddr],MIN_DO_Time,MAX_DO_Time);
				break;
			case Index_8_DO1_Item:
                ParamTemp.DO1_Item=
			    (u16)JudgeSetNewValue(&UpDataRTU,(s32)ParamTemp.DO1_Item,(s32*)&RtuCTRLDataTemp[DsAddr],MIN_DO_Item,MAX_DO_Item);
				break;
			case Index_8_DO1_Ual:
                ParamTemp.DO1_UAL=
			    (u8)JudgeSetNewValue(&UpDataRTU,(s32)ParamTemp.DO1_UAL,(s32*)&RtuCTRLDataTemp[DsAddr],MIN_DO_Ual,MAX_DO_Ual);
				break;
			case Index_8_DO1_Hys:
                ParamTemp.DO1_HYS=
			    (u16)JudgeSetNewValue(&UpDataRTU,(s32)ParamTemp.DO1_HYS,(s32*)&RtuCTRLDataTemp[DsAddr],MIN_DO_Hys,MAX_DO_Hys);
				break;
			case Index_8_DO1_Dely:
                ParamTemp.DO1_Delay=
			    (u16)JudgeSetNewValue(&UpDataRTU,(s32)ParamTemp.DO1_Delay,(s32*)&RtuCTRLDataTemp[DsAddr],MIN_DO_Dely,MAX_DO_Dely);
				break;
			/*-------------------------------------------------------------------------------------------------------------------------------------*/
			case Index_8_DO2_Mode:
                ParamTemp.DO2_Mode=
			    (u8)JudgeSetNewValue(&UpDataRTU,(s32)ParamTemp.DO2_Mode,(s32*)&RtuCTRLDataTemp[DsAddr],MIN_DO_Mode,MAX_DO_Mode);
				break;
			case Index_8_DO2_Time:
                ParamTemp.DO2_Time=
			    (u16)JudgeSetNewValue(&UpDataRTU,(s32)ParamTemp.DO2_Time,(s32*)&RtuCTRLDataTemp[DsAddr],MIN_DO_Time,MAX_DO_Time);
				break;
			case Index_8_DO2_Item:
                ParamTemp.DO2_Item=
			    (u8)JudgeSetNewValue(&UpDataRTU,(s32)ParamTemp.DO2_Item,(s32*)&RtuCTRLDataTemp[DsAddr],MIN_DO_Item,MAX_DO_Item);
				break;
			case Index_8_DO2_Ual:
                ParamTemp.DO2_UAL=
			    (u16)JudgeSetNewValue(&UpDataRTU,(s32)ParamTemp.DO2_UAL,(s32*)&RtuCTRLDataTemp[DsAddr],MIN_DO_Ual,MAX_DO_Ual);
				break;
			case Index_8_DO2_Hys:
                ParamTemp.DO2_HYS=
			    (u16)JudgeSetNewValue(&UpDataRTU,(s32)ParamTemp.DO2_HYS,(s32*)&RtuCTRLDataTemp[DsAddr],MIN_DO_Hys,MAX_DO_Hys);
				break;
			case Index_8_DO2_Dely:
                ParamTemp.DO2_Delay=
			    (u16)JudgeSetNewValue(&UpDataRTU,(s32)ParamTemp.DO2_Delay,(s32*)&RtuCTRLDataTemp[DsAddr],MIN_DO_Dely,MAX_DO_Dely);
				break;
			/*-------------------------------------------------------------------------------------------------------------------------------------*/
			case Index_8_DO3_Mode:
                ParamTemp.DO3_Mode=
			    (u8)JudgeSetNewValue(&UpDataRTU,(s32)ParamTemp.DO3_Mode,(s32*)&RtuCTRLDataTemp[DsAddr],MIN_DO_Mode,MAX_DO_Mode);
				break;
			case Index_8_DO3_Time:
                ParamTemp.DO3_Time=
			    (u16)JudgeSetNewValue(&UpDataRTU,(s32)ParamTemp.DO3_Time,(s32*)&RtuCTRLDataTemp[DsAddr],MIN_DO_Time,MAX_DO_Time);
				break;
			case Index_8_DO3_Item:
                ParamTemp.DO3_Item=
			    (u8)JudgeSetNewValue(&UpDataRTU,(s32)ParamTemp.DO3_Item,(s32*)&RtuCTRLDataTemp[DsAddr],MIN_DO_Item,MAX_DO_Item);
				break;
			case Index_8_DO3_Ual:
                ParamTemp.DO3_UAL=
			    (u16)JudgeSetNewValue(&UpDataRTU,(s32)ParamTemp.DO3_UAL,(s32*)&RtuCTRLDataTemp[DsAddr],MIN_DO_Ual,MAX_DO_Ual);
				break;
			case Index_8_DO3_Hys:
                ParamTemp.DO3_HYS=
			    (u16)JudgeSetNewValue(&UpDataRTU,(s32)ParamTemp.DO3_HYS,(s32*)&RtuCTRLDataTemp[DsAddr],MIN_DO_Hys,MAX_DO_Hys);
				break;
			case Index_8_DO3_Dely:
                ParamTemp.DO3_Delay=
			    (u16)JudgeSetNewValue(&UpDataRTU,(s32)ParamTemp.DO3_Delay,(s32*)&RtuCTRLDataTemp[DsAddr],MIN_DO_Dely,MAX_DO_Dely);
				break;
			/*-------------------------------------------------------------------------------------------------------------------------------------*/
			case Index_8_DO4_Mode:
                ParamTemp.DO4_Mode=
			    (u8)JudgeSetNewValue(&UpDataRTU,(s32)ParamTemp.DO4_Mode,(s32*)&RtuCTRLDataTemp[DsAddr],MIN_DO_Mode,MAX_DO_Mode);
				break;
			case Index_8_DO4_Time:
                ParamTemp.DO4_Time=
			    (u16)JudgeSetNewValue(&UpDataRTU,(s32)ParamTemp.DO4_Time,(s32*)&RtuCTRLDataTemp[DsAddr],MIN_DO_Time,MAX_DO_Time);
				break;
			case Index_8_DO4_Item:
                ParamTemp.DO4_Item=
			    (u8)JudgeSetNewValue(&UpDataRTU,(s32)ParamTemp.DO4_Item,(s32*)&RtuCTRLDataTemp[DsAddr],MIN_DO_Item,MAX_DO_Item);
				break;
			case Index_8_DO4_Ual:
                ParamTemp.DO4_UAL=
			    (u16)JudgeSetNewValue(&UpDataRTU,(s32)ParamTemp.DO4_UAL,(s32*)&RtuCTRLDataTemp[DsAddr],MIN_DO_Ual,MAX_DO_Ual);
				break;
			case Index_8_DO4_Hys:
                ParamTemp.DO4_HYS=
			    (u16)JudgeSetNewValue(&UpDataRTU,(s32)ParamTemp.DO4_HYS,(s32*)&RtuCTRLDataTemp[DsAddr],MIN_DO_Hys,MAX_DO_Hys);
				break;
			case Index_8_DO4_Dely:
                ParamTemp.DO4_Delay=
			    (u16)JudgeSetNewValue(&UpDataRTU,(s32)ParamTemp.DO4_Delay,(s32*)&RtuCTRLDataTemp[DsAddr],MIN_DO_Dely,MAX_DO_Dely);
				break;
		    default:
		        break;
        }
    ...
    if(UpDataRTU)
    {
        if((g_tParam.CtrlParam.Baud485 != ParamTemp.Baud485) || (g_tParam.CtrlParam.DataFormat != ParamTemp.DataFormat))
        {
            g_tParam.CtrlParam.Baud485 = ParamTemp.Baud485;
            g_tParam.CtrlParam.DataFormat = ParamTemp.DataFormat;
            USART_Configuration();
            PT_TimerDelay(10);
        }
        if(g_tParam.CtrlParam.NetMode != ParamTemp.NetMode)
        {
            g_tParam.CtrlParam = ParamTemp;
            SaveParam();
            DispMode = ReadMode;
            PT_TimerDelay(1000);
            NVIC_SystemReset();
...
void vMSRS232_Set_Adjust(u8 *pData)  // 设置校验系数
{
    ...
    switch (*pData)   // Buf[8] 开始  子命令 相位 校准数据A相
    {
        ...
        case CALIB_SetPwm:
            ...
            {
                AoNum = (u16)(500 * (59999 - 1) / 10000);
            }
            else
            {
                AoNum = (u16)(3500 * (59999 - 1) / 10000);
            }
            TIM_SetCompare4(TIM4,AoNum);
            TIM_SetCompare3(TIM4,AoNum);
            break;
        case CALIB_UIE:
            U[0] = FLIPW(pData+2);
            I[0] = FLIPW(pData+4);
            ...
            SendAdjustMsg.Cmd = *pData;
            SendAdjustMsg.Phase = *(pData+1);  //
            memcpy((u8 *)&SendAdjustMsg.Data[0], (u8 *)&U[0], Size);
            memcpy((u8 *)&SendAdjustMsg.Data[Size], (u8 *)&I[0], Size);
            RN8032_Adjust(SendAdjustMsg.Cmd,SendAdjustMsg.Phase,(u8 *) &SendAdjustMsg.Data[0]);
            break;
        case CALIB_ANGLE:  // 功率
            SendAdjustMsg.Cmd = *pData;
            SendAdjustMsg.Phase = *(pData+1);  // 第几项
            memcpy((u8 *)&SendAdjustMsg.Data[0], pData+2, 12);
            RN8032_Adjust(SendAdjustMsg.Cmd,SendAdjustMsg.Phase,(u8 *) &SendAdjustMsg.Data[0]);
            break;
        ...
        case CALIB_SET_ZERO:
            ...
            RN8032_Adjust(SendAdjustMsg.Cmd,SendAdjustMsg.Phase,(u8 *) &SendAdjustMsg.Data[0]);
            break;
        case CALIB_WRITEDATA:   // 待查验
            SendAdjustMsg.Cmd = *pData;
            SendAdjustMsg.Phase = *(pData+1);
            memcpy((u8 *)&SendAdjustMsg.Data[0], pData+2, RNPARAM_SIZE);
            RN8032_Adjust(SendAdjustMsg.Cmd,SendAdjustMsg.Phase,(u8 *) &SendAdjustMsg.Data[0]);
            break;
        default:
            break;
...
//	u8 *pData = &sg_RxPack.Data[8];
      ...
      || rtu_RxPack.RR_Addr == ADDR_PC )    // 仪表地址 判断地址
    {
        ...
        switch(CtrlType)
        {
            ...
            case 0x03:
            case 0x04:
                if(rtu_RxPack.RR_DsAddr < 0x0100)
                {
                    vModeBus_Query_Primary();
                    rtu_TxPack.RTU_DataNum = rtu_RxPack.RR_DsNum * 2;
                    memcpy((u8 *)&rtu_TxPack.Data[0x03], (u8 *)&RtuPrimaryDataTmp[rtu_RxPack.RR_DsAddr], rtu_TxPack.RTU_DataNum);
                }
                else if((rtu_RxPack.RR_DsAddr > 0x0100) && (rtu_RxPack.RR_DsAddr < 0x0200))
                {
